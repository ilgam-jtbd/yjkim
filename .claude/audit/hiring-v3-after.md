# 채용 관점 실측 — after · 2026-09-02 22:45 UTC
...
- **main commit**: 5fbd632 문서 4종 상호 이동 — 상단 탭 · 하단 이동 링크 (#34)
...
|---|---|---|---|---|---|---|---|
| index.html | 390 | 10,152 | 12.0 | 390 ✓ | — | 0 | 0 |
...
총 높이 **10,152px = 12.0화면** (목표 ≤ 10,200px / 12화면)
...
| 사례 | 제목 | 높이 | 화면 | 이미지 |
|---|---|---|---|---|
| 01 | 웍스메이트 — 거래가 구조화되지 않은 시장을 거래액 250억의 사업으로. | 1,023 | 1.21 | 0 |
| 02 | 어바웃피싱 — 측정 체계를 복구하고 ROAS 643%. | 726 | 0.86 | 0 |
| 03 | 애즈유 — 시니어 D2C 자사몰 회원을 +827%로. | 682 | 0.81 | 0 |
| 04 | VELOR — 새로운 시장을 서비스로 검증하다. | 910 | 1.08 | 2 |
| 05 | 시니어 서비스 자문 — 42일 · 산출물 50건. | 769 | 0.91 | 0 |
...
```
정본 대조 | completed | success | 5fbd632
Deploy static content to Pages | completed | success | 5fbd632
